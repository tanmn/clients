...
class BotShell extends AppShell
{
    ...
    {
        $this->out();
        $this->out('BOT Simulation by C3TEK (c3tek.biz)');
        $this->hr();
    ...
    public function readData()
    {
        ...
        $sticker = $this->MasterPoint->find('first', array(
            'conditions' => array(
        ...
        $normal = $this->MasterPoint->find('first', array(
            'conditions' => array(
                'MasterPoint.group_code' => $this->my_group,
                'MasterPoint.hotline' => $this->my_hotline,
